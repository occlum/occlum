#define NGX_CONFIGURE " --with-cc=/opt/occlum/toolchains/gcc/bin/occlum-gcc --with-cpp=/opt/occlum/toolchains/gcc/bin/occlum-g++ --without-http_rewrite_module --with-debug"
...
#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 8.3.0 (GCC) "
#endif
