...
impl !Send for LevelWaiter {}
impl !Sync for LevelWaiter {}

/// A waker can wake up the thread that its waiter has put to sleep.
pub struct LevelWaker {
    inner: Weak<Inner>,
}
...
impl LevelWaker {
    ...
    pub fn batch_wake<'a, I: Iterator<Item = &'a LevelWaker>>(iter: I) {
