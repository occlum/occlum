...
impl SocketFile {
    ...
    pub fn host_fd_inner(&self) -> HostFd {
...
mod impls {
    use crate::net::uring_socket::socket::NetlinkSocketAddr;

    use super::*;
    use io_uring_callback::IoUring;

    pub type Ipv4Stream =
        crate::net::uring_socket::stream::StreamSocket<Ipv4SocketAddr, SocketRuntime>;
    pub type Ipv6Stream =
        crate::net::uring_socket::stream::StreamSocket<Ipv6SocketAddr, SocketRuntime>;
    ...
    pub type Ipv4Datagram =
        crate::net::uring_socket::datagram::DatagramSocket<Ipv4SocketAddr, SocketRuntime>;
    pub type Ipv6Datagram =
        crate::net::uring_socket::datagram::DatagramSocket<Ipv6SocketAddr, SocketRuntime>;
    // pub type UnixDatagram = async_socket::DatagramSocket<UnixAddr, SocketRuntime>;
    pub type NetlinkDatagram =
        crate::net::uring_socket::datagram::NetlinkSocket<NetlinkSocketAddr, SocketRuntime>;

    pub struct SocketRuntime;

    impl crate::net::uring_socket::runtime::Runtime for SocketRuntime {
