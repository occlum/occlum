...
use crate::fs::{
    ...
    do_fsync, do_ftruncate, do_futimesat, do_getcwd, do_getdents, do_getdents64, do_io_cancel,
    do_io_destory, do_io_getevents, do_io_setup, do_io_submit, do_ioctl, do_lchown, do_link,
    do_linkat, do_lseek, do_lstat, do_mkdir, do_mkdirat, do_mount, do_mount_rootfs, do_open,
    do_openat, do_pipe, do_pipe2, do_pread, do_preadv, do_pwrite, do_pwritev, do_read, do_readlink,
    do_readlinkat, do_readv, do_rename, do_renameat, do_rmdir, do_sendfile, do_stat, do_statfs,
    do_symlink, do_symlinkat, do_sync, do_timerfd_create, do_timerfd_gettime, do_timerfd_settime,
    do_truncate, do_umask, do_umount, do_unlink, do_unlinkat, do_utime, do_utimensat, do_utimes,
    do_write, do_writev, iovec_t, utimbuf_t, AsTimer, File, FileDesc, FileRef, HostStdioFds, Stat,
    Statfs,
};
...
macro_rules! process_syscall_table_with_callback {
    ($callback: ident) => {
        $callback! {
            ...
            (IoSetup = 206) => do_io_setup(nr_events: c_int, ctxpp: u64),
            (IoDestroy = 207) => do_io_destory(ctxp: u64),
            (IoGetevents = 208) => do_io_getevents(ctxp: u64, min_nr: c_long, nr: c_long, events: u64, timeout: u64),
            (IoSubmit = 209) => do_io_submit(ctxp: u64, nr: c_long, iocbpp: u64),
            (IoCancel = 210) => do_io_cancel(ctxp: u64, iocbp: u64, events: u64),
